...
@FacesComponent(value = HijriDatePicker.COMPONENT_TYPE)
@ResourceDependencies({
        @ResourceDependency(library="css", name="ui.calendars.picker.css"),
        @ResourceDependency(library="js", name="jquery.min.js"),
        @ResourceDependency(library="js", name="jquery.calendars.js"),
        @ResourceDependency(library="js", name="jquery.calendars.plus.js"),
        @ResourceDependency(library="js", name="jquery.calendars.ummalqura.js"),
        @ResourceDependency(library="js", name="jquery.calendars.ummalqura-ar.js"),
        @ResourceDependency(library="js", name="jquery.plugin.js"),
        @ResourceDependency(library="js", name="jquery.calendars-ar.js"),
        @ResourceDependency(library="js", name="jquery.calendars.picker-ar.js"),
        @ResourceDependency(library="js", name="jquery.calendars.picker.js"),
        //@ResourceDependency(library="primefaces", name="jquery/jquery.js"),
        @ResourceDependency(library="primefaces", name="primefaces.js")
})
public class HijriDatePicker extends HtmlInputText implements Widget {

    public static final String COMPONENT_TYPE = "com.dawlatalislam.registration.HijriDatePicker";
    public static final String COMPONENT_FAMILY = "org.primefaces.component";
    private static final String DEFAULT_RENDERER = "com.dawlatalislam.registration.HijriDatePickerRenderer";
    private static final String OPTIMIZED_PACKAGE = "com.dawlatalislam.registration.";
