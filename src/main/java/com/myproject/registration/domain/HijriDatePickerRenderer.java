...
@FacesRenderer(componentFamily = HijriDatePicker.COMPONENT_FAMILY, rendererType = HijriDatePickerRenderer.RENDERER_TYPE)
public class HijriDatePickerRenderer extends CoreRenderer {
    public static final String RENDERER_TYPE = "com.dawlatalislam.registration.HijriDatePickerRenderer";
    @Override
    public void decode(FacesContext context, UIComponent component) {

        HijriDatePicker calendar = (HijriDatePicker) component;
    ...
    protected void encodeMarkup(FacesContext context, HijriDatePicker calendar, String value) throws IOException {
    ...
    protected void encodeInput(FacesContext context, HijriDatePicker calendar, String id, String value, boolean popup) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
    ...
    protected void encodeScript(FacesContext context, HijriDatePicker calendar, String value) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
        String clientId = calendar.getClientId(context);
